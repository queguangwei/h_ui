<template>
	<div class="demo-ceshi">
	  <h2>基本用法 手风琴</h2>
    <h-form>
      <h-collapse v-model="value1" @on-change="change">
        <h-panel name="1">
          <div slot="content">
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-date-picker type="date" placeholder="选择日期" style="width: 200px"></h-date-picker></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
            <h-form-item><h-select></h-select></h-form-item>
          </div>
        </h-panel>
    ...
    <h2>手风琴</h2>
    <h-collapse v-model="value2" accordion>
      <h-panel name="1">
        史蒂夫·乔布斯
    ...
    <h2>面板嵌套</h2>
    <h-collapse accordion v-model="value3">
      <h-panel name="1">
        史蒂夫·乔布斯
        <div slot="content">
          史蒂夫·乔布斯（Steve Jobs），1955年2月24日生于美国加利福尼亚州旧金山，美国发明家、企业家、美国苹果公司联合创办人。
          <h-collapse accordion v-model="value4">
            <h-panel name="1-1">
              iPhone
