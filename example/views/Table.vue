<template>
  <div>
    ...
    <h-table :columns="columns10" :height="300" :data="data9" @on-expand="expand" closeExpandResize @on-row-click="rowclick" @on-row-dblclick="rowdblclick" :loading="loading" border></h-table>
    <h2>设置大小</h2>
      ...
      data17: [
        {
            ...
            "weak": "730,124,2",
            "signin": null,
            "click": '0254111111111111111111111111111111111111',
            "active": 1438,
            "day7": 274,
            "day30": 285,
            "tomorrow": 1727,
