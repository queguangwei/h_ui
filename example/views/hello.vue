  ...
  <!-- <h-msg-box v-model="show" escClose> -->
    <h-form ref="formValidate" :model="formValidate" cols="2" :label-width="80">
      ...
      <h-form-item label="select" prop="city1">
          <h-select v-model="formValidate.city1"  filterable placeholder="请选择所在地" class="curItemClass" >
              <h-option value="beijing">北京市</h-option>
              <h-option value="beijing1">北京市1</h-option>
              <h-option value="beijing2">北京市2</h-option>
              <h-option value="beijing3">北京市3</h-option>
              <h-option value="shanghai">上海市</h-option>
              <h-option value="shanghai1">上海市1</h-option>
              <h-option value="shenzhen">深圳市</h-option>
              <h-option value="shenzhen1">深圳市2</h-option>
          </h-select>
      </h-form-item>
...
export default {
  data() {
    return {
      ...
      bigData: [
        { value: "value1", label: "label1",label1: "多列11111111111"},
