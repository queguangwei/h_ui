<template>
  <div>
    ...
    <h-msg-box v-model="modal5" title="自定义宽度" width="300">
      <p>自定义宽度，单位 px，默认 520px。</p>
      <p>
        对话框的宽度是响应式的，当屏幕尺寸小于 768px
        时，宽度会变为自动<code>auto</code>。
      </p>
    </h-msg-box>
    <h1>实例化使用方法</h1>
    <h2>基本用法</h2>
    ...
    <h-msg-box width="80" height="70" v-model="modal6">
...
export default {
  ...
  methods: {
    ...
    canMax(e) {
      console.log(e)
      function getMsgBoxTop() {
        return window.innerHeight / 30
      }

      function getMsgBoxWidth() {
        return window.innerWidth * 0.88
      }
      if (!e) {
        this.width = getMsgBoxWidth()
        this.top = getMsgBoxTop()
      }
    },
    onClose() {
