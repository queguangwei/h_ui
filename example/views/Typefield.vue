<template>
  <div id="input" class="wrapper">
    ...
    <h1>algin设置左中右</h1>
      {{value11}}
      <h-typefield v-model="value11" hoverTips integerNum="17" suffixNum="2" type="money" bigTips placeholder="金额"  @on-blur="s" style="width:300px" algin="left" ref="test"></h-typefield>
