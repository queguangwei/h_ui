      ...
      <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
        <div :class="[datePrefixCls + '-header']" v-show="leftCurrentView !== 'time'">
          <span
            ...
            @click="prevYear('left')"><Icon name="return"></Icon></span>
          <span
            :class="iconBtnCls('prev')"
            @click="prevMonth"
            v-show="leftCurrentView === 'date'"><Icon name="return"></Icon></span>
          <span
          ...
          <span
            ...
            @click="nextYear('left')"
            v-show="leftCurrentView === 'year' || leftCurrentView === 'month'"><Icon type="enter"></Icon></span>
        </div>
        <date-table
      ...
      <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
        <div :class="[datePrefixCls + '-header']" v-show="rightCurrentView !== 'time'">
          <span
            ...
            v-show="rightCurrentView === 'year' || rightCurrentView === 'month'"><Icon name="return"></Icon></span>
          <span
            :class="[datePrefixCls + '-header-label']"
          ...
          <span
            :class="iconBtnCls('next', '-double')"
            @click="nextYear('right')"><Icon name="enter"></Icon></span>
          <span
            :class="iconBtnCls('next')"
            @click="nextMonth"
            v-show="rightCurrentView === 'date'"><Icon name="enter"></Icon></span>
        </div>
        <date-table
