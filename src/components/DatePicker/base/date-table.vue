            ...
            getCellCls (cell) {
                return [
                    `${prefixCls}-cell`,
                    {
                        ...
                        [`${prefixCls}-cell-disabled`]: cell.disabled||(this.spliceDirec=='right'&&cell.date<this.rangeState.from)||(this.maxDate&&cell.date>this.maxDate),
                        ...
                        [`${prefixCls}-cell-left`]: this.spliceDirec&&this.spliceDirec=='left',
                        [`${prefixCls}-cell-right`]: this.spliceDirec&&this.spliceDirec=='right',
                    }
                ];
            },
